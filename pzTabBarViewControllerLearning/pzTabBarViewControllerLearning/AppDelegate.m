...
{
    //basic rootview controller has to be tabBarcontroler.. each of its iitem can be eitehr UIviewcontroller or uinavigationViewController
    
    self.window = [[UIWindow alloc]initWithFrame:[[UIScreen mainScreen ]bounds]];
    [self.window makeKeyAndVisible];
    firstViewController * firstVC = [[firstViewController alloc]initWithNibName:nil bundle:NULL];
    ...
    [tabBarController setViewControllers:@[firstNavigationVC,secondVC]];
